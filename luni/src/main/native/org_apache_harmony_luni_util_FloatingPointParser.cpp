...
void register_org_apache_harmony_luni_util_fltparse(JNIEnv* env) {
    jniRegisterNativeMethods(env, "org/apache/harmony/luni/util/FloatingPointParser", gMethods, NELEM(gMethods));
}
